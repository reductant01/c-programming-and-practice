...
int main() {
    ...
    while (1)
    {
        ...
        cout << "\n선택 1: Coder 객체 10개 입력과 출력, 2. PartTimeStudent 객체 10개 입력과 출력, 3: Coder객체 정렬,4. partTimeStudents 객체 정렬, 5. Bag 테스트, 6. 종료" << endl;
        cin >> select;
        ...
        case 5:
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                pts->print();
               // cout << "Delete::" << s.Delete() << endl;//동적 바인딩 처리하도록 수정
            }
             break;
        default:
            exit(0);
